...
/**
 * Check if a given object implements the CreatedThreadResponse interface.
 */
export function instanceOfCreatedThreadResponse(value: object): boolean {
    let isInstance = true;
...
export function CreatedThreadResponseFromJSON(json: any): CreatedThreadResponse {
    return CreatedThreadResponseFromJSONTyped(json, false);
}

export function CreatedThreadResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreatedThreadResponse {
...
export function CreatedThreadResponseToJSON(value?: CreatedThreadResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
